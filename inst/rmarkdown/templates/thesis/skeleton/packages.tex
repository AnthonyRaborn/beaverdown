...
\usepackage{epsfig}
%\usepackage{euscript}
\usepackage[format=hang,justification=raggedright,singlelinecheck=false,labelsep=period]{caption}
...
%\usepackage{hypernat}
% the below included to make use of kable and kableExtra for automatic tables in R
\usepackage{float}
