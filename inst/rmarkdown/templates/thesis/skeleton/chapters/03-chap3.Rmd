...
```{r reedlogo, fig.cap="Frogs are weird...", out.width = "9cm", eval = F}
# not evaluated
...
```{r subd, results="asis", echo=FALSE, fig.cap="Subdiv. graph", out.extra="scale=0.75", eval = F}
...
```{r subd2, results="asis", echo=FALSE, out.extra="angle=180, scale=1.1", fig.cap="A Larger Figure, Flipped Upside Down", eval = F}
include_graphics("figure/subdivision.pdf")
```
