...
#' to specify using the University of Florida Thesis/Dissertation LaTeX
#'  template and cls files.
#'
#' @export
...
#' @examples
#' \dontrun{
#'  output: gatordown::thesis_gitbook
#' }
